...
public class CadastroUsuarioRest extends AsyncTask<Usuario, Void, String>{
	private int userID;
...
protected String doInBackground(Usuario... params) {
	try {
		...
		String url = "http://192.168.1.31:8081/HelpRadar_JSF2.2/rest/usuario/cadastrarUsuario/";
